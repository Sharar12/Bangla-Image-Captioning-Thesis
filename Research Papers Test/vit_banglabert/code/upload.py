...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.vit = AutoModel.from_pretrained(vit_path, trust_remote_code=True)
...
vit_path = (
    VIT_MODEL_PATH if os.path.exists(VIT_MODEL_PATH) else "google/vit-base-patch16-224"
)
...
<head>
    ...
    <title>Bangla Image Captioning - ViT + BanglaBERT</title>
    <style>
...
<body>
    <div class="container">
        ...
        <p class="subtitle">ViT-base + BanglaBERT</p>
