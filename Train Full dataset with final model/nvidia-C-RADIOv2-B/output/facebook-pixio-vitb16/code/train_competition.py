...
DATA_DIR = r"/Final_Hybrid_Dataset_60k"
...
class Encoder(nn.Module):
    def __init__(self):
        super().__init__()
        self.vit = ViTModel.from_pretrained(MODEL_NAME, token=HF_TOKEN, ignore_mismatched_sizes=True)
...
def train():
    ...
    print(f"\nPixIO ViT MODE: {NUM_LAYERS} Layers | {HIDDEN_DIM} Hidden | DROPOUT: {DROPOUT} | MAX_LR: {MAX_LR}")
