...
EMBED_DIM = 768               # Matches C-RADIOv2-B
...
FEATURE_DIM = 768             # C-RADIOv2-B hidden size
...
# ==========================================
# 3. HIGH-IQ TRANSFORMER MODEL (C-RADIOv2)
# ==========================================
...
def train():
    ...
    print(f"\nC-RADIOv2 MODE: {NUM_LAYERS} Layers | {HIDDEN_DIM} Hidden | OneCycle LR")
