...
MODEL_DIR = os.path.join(PROJECT_DIR, "models", "google-vit-base-patch16-224", "model")
OUTPUT_DIR = os.path.join(PROJECT_DIR, "models", "google-vit-base-patch16-224", "output")
