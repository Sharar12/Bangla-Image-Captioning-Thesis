...
DATA_DIR = (
    r"D:\Python Projects\Train Full dataset with final model - For Thesis\Final_Hybrid_Dataset_60k"
)
...
def train():
    ...
    for epoch in range(EPOCHS):
        ...
        if (epoch + 1) == 20:
            torch.save(
                {"epoch": epoch + 1, "full_model": model, "vocab": vocab.word2idx},
                os.path.join(OUTPUT_DIR, "checkpoint_epoch_20.pt"),
            )
            print(f"\n--- Standalone multimodal checkpoint saved for Epoch 20! ---")
