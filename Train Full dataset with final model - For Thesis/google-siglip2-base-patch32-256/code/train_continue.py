...
EPOCHS = 20                   # Trends lock in after 10 epochs
...
NUM_LAYERS = 6                # Match checkpoint
HIDDEN_DIM = 2048             # Match checkpoint
DROPOUT = 0.1
LABEL_SMOOTHING = 0.1
...
def find_latest_checkpoint(output_dir):
    ...
    return os.path.join(output_dir, f"checkpoint_epoch_{latest_epoch}.pt"), latest_epoch
...
def train():
    ...
    if checkpoint_path:
        ...
        print(f"Successfully loaded model and optimizer state from epoch {last_epoch}")
    else:
    ...
    print(f"Continuing from epoch {start_epoch} to epoch {EPOCHS}\n")
