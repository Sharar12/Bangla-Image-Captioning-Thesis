...
class Encoder(nn.Module):
    def __init__(self):
        ...
        for param in self.siglip.vision_model.encoder.layers[-8:].parameters():
...
def train():
    ...
    optimizer = torch.optim.AdamW(all_params, lr=MAX_LR, weight_decay=WEIGHT_DECAY)
    ...
    print(f"Vocab Filter: min_freq={MIN_FREQ} | Vision Fine-tuning: Last 6 layers unfrozen")
