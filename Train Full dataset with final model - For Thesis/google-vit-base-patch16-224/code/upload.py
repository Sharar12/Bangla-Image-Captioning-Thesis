...
<head>
    ...
    <title>Bangla Image Captioning - ViT</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .upload-box.dragover { border-color: #60a5fa; background: #1e3a5f; }
        .upload-label {
...
<body>
    <div class="container">
        ...
        <p class="subtitle">Vision Transformer (ViT) + Custom Decoder</p>
...
if __name__ == "__main__":
    print(f"Server starting at http://localhost:8181")
    app.run(host="0.0.0.0", port=8181, debug=False, threaded=False)
