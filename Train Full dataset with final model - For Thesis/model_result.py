...
BASE_DIR = r"D:\Python Projects\Train Full dataset with final model - For Thesis"

MODEL_FOLDERS = {
    "SigLIP2 + BanglaBERT": os.path.join(BASE_DIR, "siglip2_banglabert", "output"),
    "SigLIP2 + BanglaGPT": os.path.join(BASE_DIR, "siglip2_BanglaGPT", "output"),
    "SigLIP2 + Att-GRU": os.path.join(BASE_DIR, "siglip2_Att_GRU", "output"),
    "SigLIP2 + Transformer Decoder": os.path.join(
        BASE_DIR, "google-siglip2-base-patch32-256", "output_new"
    ),
}
